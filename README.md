...
* **тримається, але оберти не змінюються** — вентиляторами керує щось інше,
  зазвичай вбудований контролер плати, який постійно перезатирає PWM (часто
  на платах Gigabyte);
* **оберти змінюються** — керування працює.
