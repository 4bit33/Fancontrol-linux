...
* **Хто керує кожним вентилятором** — перемикач на картці: **Прошивка**
  (плата чи відеокарта сама, як без програми), **Моя крива** або **Разом**:
  поки холодно — прошивка, з вибраної температури — ваша крива. Для
  відеокарти «Разом» означає, що в простої її вентилятори стоять.
...
прибрати. На картці вентилятора **Прошивка / Моя крива / Разом** вибирає,
хто ним керує, а в режимі «Разом» картка показує, хто керує саме зараз;
⚙ — мінімум, старт і обмеження швидкості. Датчики можна перейменовувати
подвійним кліком.
